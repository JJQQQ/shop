			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="/zl_shop/admin.php/Index/Index" class="dropdown-toggle">
...
<div class="row">
    ...
    <div class="col-xs-12">
        <div>
            <h2><a href="/zl_shop/admin.php/Admin"> 员工管理</a></h2>
        </div>
        <div>
            <h2><a href="/zl_shop/admin.php/Goods"> 商品管理</a></h2>
        </div>
        <div>
            <h2><a href="/zl_shop/admin.php/Orders"> 订单管理</a></h2>
        </div>
        <div>
            <h2><a href="/zl_shop/admin.php/News"> 新闻管理</a></h2>
        </div>
    </div>
</div>
