			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="/zl_shop/admin.php/Posts/Index" class="dropdown-toggle">
 ...
 <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                <h1>
                    <a href="/zl_shop/admin.php/Posts/add">添加展示图</a>
                </h1>
                                ...
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
									...
									<tbody>
                                        <?php if(is_array($posts)): foreach($posts as $key=>$post): ?><tr>
                                            ...
                                            <td class="hidden-480"><img width="150" src="/zl_shop/Public/Uploads/posts/a_<?php echo ($post['pic']); ?>" /></td>
										    ...
										    <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <p><a href="/zl_shop/admin.php/Posts/del/id/<?php echo ($post['id']); ?>" class="btn btn-xs btn-danger">
                                                        <i class="delposts icon-trash bigger-120">删除</i>
                                                    </a></p>
													<p><a href="/zl_shop/admin.php/Posts/update/id/<?php echo ($post['id']); ?>/type/1" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120">设置为新添加</i>
                                                    </a></p>
													<p><a href="/zl_shop/admin.php/Posts/update/id/<?php echo ($post['id']); ?>/type/2" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120">设置为已发布</i>
                                                    </a></p>
													<p><a href="/zl_shop/admin.php/Posts/update/id/<?php echo ($post['id']); ?>/type/3" class="btn btn-xs btn-info">
