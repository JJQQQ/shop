			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="/zl_shop/admin.php/Attrvalue/Index" class="dropdown-toggle">
        ...
        <div class="page-content">
            <div class="page-header" style="height: 50px">
                <h1 style="display: inline;">
                    <a href="/zl_shop/admin.php/Attrvalue/add"><i class="icon-plus"></i>添加属性</a>
                </h1>
                <div id="nav-search" style="float: right;">
                    <form action="/zl_shop/admin.php/Attrvalue/index" id="searchForm" method="get">
                    	<input type="text" name="attrvalue" value="<?php echo ($map['attrvalue']); ?>" placeholder="属性值" style="height: 35px" />
                    	<input type="text" name="attrname" value="<?php echo ($map['attrname']); ?>" placeholder="属性名" style="height: 35px" />
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($attrvalues)): foreach($attrvalues as $key=>$attrvalue): ?><tr>
                                                    <td><?php echo ($attrvalue['attrname']); ?></td>
                                                    <td class="hidden-480 center"><?php echo ($attrvalue['attrvalue']); ?></td>
                                                    <td class="hidden-480 center"><?php echo ($attrvalue['state']==1?'显示':'不显示'); ?></td>
                                                    <td class="hidden-480">
                                                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                            <a href="/zl_shop/admin.php/Attrvalue/edit/id/<?php echo ($attrvalue['id']); ?>" class="btn btn-xs btn-info">
                                                                <i class="icon-edit bigger-120">修改</i>
                                                            </a>
                                                            <a href="/zl_shop/admin.php/Attrvalue/del/id/<?php echo ($attrvalue['id']); ?>" class="btn btn-xs btn-danger">
...
<script type="text/javascript">
    ...
    function searchFrom(){
        ...
        $.ajax({
            type : 'post',
            url : '/zl_shop/admin.php/Attrvalue/index',
            data : formData,
