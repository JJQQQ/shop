                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($links)): foreach($links as $key=>$link): ?><tr>
                                            <td class="center">
                                                <label>
                                                    <input type="checkbox" class="ace" />
                                                    <span class="lbl"></span>
                                            ...
                                            <td>
                                                <a href="#"><?php echo ($link['id']); ?></a>
                                            </td>
                                            <td><?php echo ($link['linkname']); ?></td>
                                            <td class="hidden-480">
												<span class="label label-sm label-warning"><?php echo ($link['linkaddress']); ?></span>
											</td>
                                            <td><img src="/zl_shop/Public/Uploads/links/s_<?php echo ($link['linklogo']); ?>"/></td>
                                            <td><?php echo ($state[$link['state']]); ?></td>
                                            <td><?php echo (date("Y-m-d",$link['addtime'])); ?></td>
                                           <!--  <td class="hidden-480">
                                                <span><?php echo ($link['sort']); ?></span>
                                            </td> -->
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a href="/zl_shop/admin.php/Link/edit/id/<?php echo ($link['id']); ?>" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120"></i>
                                                    </a>
                                                    <a href="/zl_shop/admin.php/Link/del/id/<?php echo ($link['id']); ?>" class="btn btn-xs btn-danger">
                                                        <i class="dellink icon-trash bigger-120"></i>
                                                    </a>
                                                </div>
                                            </td>
