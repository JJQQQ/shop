                                ...
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $key=>$content): ?><tr>
                                            ...
                                            <td><?php echo ($content['leavemessage_id']); ?></td>
                                            <td class="hidden-480"><?php echo ($content['content']); ?></td>
                                           
											<td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo (date('Y-m-d H:i:s',$content['addtime'])); ?></span>
                                            </td>
											 <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo ($content['admin_id']); ?></span>
                                            </td>
										

                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a href="/zl_shop/admin.php/Leave/checkreply/id/<?php echo ($content['id']); ?>" class="btn btn-xs btn-info">
