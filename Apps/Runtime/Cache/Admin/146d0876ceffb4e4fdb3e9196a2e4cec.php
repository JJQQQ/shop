        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="/zl_shop/admin.php/Brands/update" class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($brand['id']); ?>" />
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 选择类别 </label>
                            <div class="col-sm-9">
                                <div class="col-sm-9">
                                    <?php if(is_array($types)): foreach($types as $key=>$type): ?><label style="margin-right:5px;line-height:27px"><input type="checkbox" name="type_id[]" <?php echo ($state[$type['id']]); ?> class="ace" value="<?php echo ($type['id']); ?>" /><?php echo ($type['name']); ?> <span  class="lbl"></span></label><?php endforeach; endif; ?>
                                    </span>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 品牌名称 </label>

                            <div class="col-sm-9">
                                <input name="name" type="text" id="form-field-1" value="<?php echo ($brand['name']); ?>" class="col-xs-10 col-sm-3" />
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"> 品牌Logo </label>

                            <div class="col-sm-9">
                                <input type="file" name="logo" id="form-field-2" class="col-xs-10 col-sm-3" />
                                <span class="help-inline col-xs-12 col-sm-7">
                                    <span class="middle"></span>
                                </span>
                            </div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="state" class="ace" type="radio" value="1" <?php echo ($brand['state']==1?'checked': ''); ?> />
								<span class="lbl"> 显示</span>
								<input name="state" class="ace" type="radio" value="2" <?php echo ($brand['state']==2?'checked': ''); ?> />
						...
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 排序 </label>
								<div class="col-sm-9">
									<input type="text" name="order" value="<?php echo ($brand['order']); ?>" class="col-xs-10 col-sm-3" id="form-input-readonly" />
									<span class="help-inline col-xs-12 col-sm-7">
										<label class="middle">
											<span class="lbl"></span>
										</label>
