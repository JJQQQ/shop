			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="/zl_shop/admin.php/Notices/Index" class="dropdown-toggle">
 ...
 <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                <h1>
                    <a href="/zl_shop/admin.php/Notices/add">发布消息</a>
                </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $key=>$notice): ?><tr>
                                            <td class="center">
                                                <label>
                                                    <input type="checkbox" class="ace" />
                                                    <span class="lbl"></span>
                                            ...
                                            <td>
                                                <a href="#"><?php echo ($notice['id']); ?></a>
                                            </td>
                                            <td><?php echo ($notice['user_id']); ?></td>
                                            <td class="hidden-480"><?php echo ($notice['type']==1?"系统消息":""); ?></td>
                                            <td><?php echo ($notice['title']); ?></td>
                                            <td><?php echo ($notice['content']); ?></td>
                                            
                                            <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo (date("Y-m-d H:i:s",$notice['addtime'])); ?></span>
                                            </td>
											 <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo ($notice['state']); ?></span>
                                            </td>
											 <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo ($notice['admin_id']); ?></span>
                                            </td>
										

                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a href="/zl_shop/admin.php/Notices/edit/id/<?php echo ($notice['id']); ?>" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120">修改</i>
                                                    </a>

                                                    <a href="/zl_shop/admin.php/Notices/del/id/<?php echo ($notice['id']); ?>" class="btn btn-xs btn-danger">
                                                        <i class="icon-trash bigger-120">删除</i>
                                                    </a>
                                                </div>
                                            </td>
                                        </tr><?php endforeach; endif; ?>
                                        <tr><td colspan="10"><?php echo ($page); ?></td></tr>
                                    </tbody>
                                </table>
