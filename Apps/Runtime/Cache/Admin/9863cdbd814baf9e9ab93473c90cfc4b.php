	...
	<body class="login-layout">
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="/zl_shop/admin.php/Login/prologin" method="post" enctype="multipart/form-data">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<img src="/zl_shop/admin.php/Login/code" id="code"/>
															<i class="icon-lock"></i>
														</span>
													</label>
													...
													<div class="clearfix">
														<label class="inline">
															<input type="text" name="code" class="ace col-sm-1" />
														</label>
		...
		<script type="text/javascript">
			...
			code.onclick = function(){
				var c = "/zl_shop/admin.php/Login/code?"+Math.random();
				this.src = c;
			}
