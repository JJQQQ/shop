			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="/zl_shop/admin.php/Leave/Index" class="dropdown-toggle">
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $key=>$content): ?><tr>
                                            <td class="center">
                                                <label>
                                                    <input type="checkbox" class="ace" />
                                                    <span class="lbl"></span>
                                            ...
                                            <td>
                                                <a href="#"><?php echo ($content['id']); ?></a>
                                            </td>
                                            <td><?php echo ($content['user_id']); ?></td>
                                            <td class="hidden-480"><?php echo ($content['content']); ?></td>
                                            <td><?php if(($content['type'] == 1)): ?>投诉
											    <?php elseif($content['type'] == 2 ): ?>建议
												<?php else: ?>留言<?php endif; ?>
										    </td>

                                            <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo ($content['state']==1?"未查看":"已查看"); ?></span>
                                            </td>
											 <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo (date('Y-m-d H:i:s',$new['addtime'])); ?></span>
                                            </td>
											 <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo ($content['ip']); ?></span>
                                            </td>
										

                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a href="/zl_shop/admin.php/Leave/check/id/<?php echo ($content['id']); ?>" class="btn btn-xs btn-info">
