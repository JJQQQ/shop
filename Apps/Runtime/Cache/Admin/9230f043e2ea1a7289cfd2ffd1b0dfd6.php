			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="/zl_shop/admin.php/Review/Index" class="dropdown-toggle">
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($goodsreviews)): foreach($goodsreviews as $key=>$reviews): ?><tr>
                                            <td class="center">
                                                <label>
                                                    <input type="checkbox" class="ace" />
                                                    <span class="lbl"></span>
                                            ...
                                            <td>
                                                <a href="#"><?php echo ($reviews['id']); ?></a>
                                            </td>
                                            <td><?php echo ($reviews['goods_id']); ?></td>
                                            <td><?php echo ($reviews['user_id']); ?></td>
                                            <td><?php echo ($state[$reviews['state']]); ?></td>
                                            <td><?php echo ($reviews['star']); ?></td>
                                            <td><?php echo ($reviews['message']); ?></td>
                                            <td><?php echo (date("Y-m-d",$reviews['addtime'])); ?></td>
                                            <td><?php echo ($reviews['goods_name']); ?></td>

                                            <td class="hidden-480">
                                                <span><?php echo ($reviews['goods_pic']); ?></span>
                                            </td>
											<td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo ($reviews['ip']); ?></span>
                                            </td>

                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a href="/zl_shop/admin.php/Review/insert/id/<?php echo ($reviews['id']); ?>" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120">回复</i>
                                                    </a>

                                                    <a href="/zl_shop/admin.php/Review/del/id/<?php echo ($reviews['id']); ?>" class="delreview btn btn-xs btn-danger">
