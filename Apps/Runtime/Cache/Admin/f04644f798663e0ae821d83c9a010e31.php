 ...
 <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                <h1>
                   <a href="/zl_shop/admin.php/News/add">发布新闻</a>
                </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $key=>$new): ?><tr>
                                            <td class="center">
                                                <label>
                                                    <input type="checkbox" class="ace" />
                                                    <span class="lbl"></span>
                                            ...
                                            <td>
                                                <a href="#"><?php echo ($new['id']); ?></a>
                                            </td>
                                            <td><?php echo ($new['title']); ?></td>
                                            <td class="hidden-480"><?php echo ($new['content']); ?></td>
                                            <td><?php echo ($type[$new['type']]); ?></td>

                                            <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo (date("Y-m-d H:i:s",$new['addtime'])); ?></span>
                                            </td>
											 <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo ($state[$new['state']]); ?></span>
                                            </td>
											 <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?php echo ($new['user_id']); ?></span>
                                            </td>
										

                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a href="/zl_shop/admin.php/News/edit/id/<?php echo ($new['id']); ?>" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120">修改</i>
                                                    </a>

                                                    <a href="/zl_shop/admin.php/News/del/id/<?php echo ($new['id']); ?>" class="btn btn-xs btn-danger">
                                                        <i class="delnews icon-trash bigger-120">删除</i>
                                                    </a>
                                                </div>
                                            </td>
