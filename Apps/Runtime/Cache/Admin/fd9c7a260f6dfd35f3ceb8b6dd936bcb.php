...
<div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="/zl_shop/admin.php/Type/index">商品分类管理</a>
                </li>
        ...
        <div class="page-content">
            <div class="page-header">
                <h1>
                    <a href="/zl_shop/admin.php/Type/index">返回分类列表</a>
                </h1>
            </div><!-- /.page-header -->
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="/zl_shop/admin.php/Type/update" class="form-horizontal" method="post" role="form" >
                        <input type="hidden" name="id" value="<?php echo ($type['id']); ?>" />
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 分类名称 </label>
                            <div class="col-sm-9">
                                <input name="name" value="<?php echo ($type['name']); ?>" type="text" id="form-field-1" class="col-xs-10 col-sm-3" />
                                <span class="help-inline col-xs-12 col-sm-7">
                                    <span class="middle" id="msg"></span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="state" class="ace" value="1" <?php echo ($type['state'] == 1 ? 'checked' : ''); ?> type="radio">
                                <span class="lbl"> 显示</span>
                                <input name="state" class="ace" value="2" <?php echo ($type['state'] == 2 ? 'checked' : ''); ?> type="radio">
                                <span class="lbl"> 不显示</span>
                                <input name="state" class="ace" value="3" <?php echo ($type['state'] == 3 ? 'checked' : ''); ?> type="radio">
                                <span class="lbl"> 是否推荐</span>
                                <input name="state" class="ace" value="4" <?php echo ($type['state'] == 4 ? 'checked' : ''); ?> type="radio">
                                <span class="lbl"> 是否首页展示</span>
                            </div>
                        </div>
